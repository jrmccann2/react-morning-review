...
class App extends Component { 
  // extends Component means we will inherit some of the functionality of the Component class that comes with React
  constructor() {
    // constructor is the first lifecycle method and runs once for each instance of a component
    super();
    // super invokes the constructor of the class that we are extending (Component in this case)
    ...
    /**
     * We declare state within our constructor as an object. We give it a skeleton of initial properties
     * that we want it to have. More often than not, you should set those properties equal to the empty form
     * of the datatype that we expect the values to be. In this case, "input" will handle the text entered into
     * our input element and so we set it to an empty string. "List" will be an array of these strings so we 
     * set it to an empty array.
     */
    this.handleClick = this.handleClick.bind(this)
    // Here we create a function that is equal to our "handleClick" bound to the context of "this" which is our class App
  }
  ...
  /**
   * handleChange utilizes arrow function syntax to show that a method can get implicit context if written as a function
  ...
  render() {
    /**
     * render is a method used by react to know what to display from a component. We write our JSX in the return from render
     * and React converts it into valid HTML
    */
    return (
       /**
        * We put all of our JSX in parentheses to allow us to have our JSX on multiple lines. Otherwise, we would have to
        * type it all on one line because returns are single line in JavaScript.
        */
      <div>
     ...
     * value - the text inside of the input box. We use this to allow our handleClick function to reset our input box
     *         because the handleClick sets this.state.input equal to "" (line 57)
     * onChange - an event handler that we can have fire a function anytime the value of our input box changes
     */
  }
}
 ...
 * Component is exported but without the default keyword
 * 
